...
ColorAppearance::ColorAppearance () : FoldableToolPanel (this, TOOL_NAME, M ("TP_COLORAPP_LABEL"), false, true)
{
    ...
    genVBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
...
//    ybscen->throwOnButtonRelease();
    ...
    setExpandAlignProperties (expadjust, true, false, Gtk::Align::FILL, Gtk::Align::START);
    ...
    */
    ...
    p2VBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
...
//    pack_start (*p2Frame, Pack::EXPAND_WIDGET, 4);
    ...
    p3VBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
...
//    tempout->throwOnButtonRelease();
    ...
    tempgreenVBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
