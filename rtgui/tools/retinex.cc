      ...
      lastmedianmap(false)
{
    ...
    setExpandAlignProperties(retinexGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(retinexMethod, true, true, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(retinexcolorspace, true, true, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(labview, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    viewgrid->attach(*labview, 0, 0, 1, 1);

    viewMethod = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(viewMethod, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(mapMethod, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(curveEditormap, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(h_tonalwidth, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(s_tonalwidth, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(settingsGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
...
// GTK318
    ...
    setExpandAlignProperties(curveEditorGD, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(curveEditorGDH, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(curveEditorGH, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(gammaretinex, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
...
// GTK318
    ...
    setExpandAlignProperties(transmissionCurveEditorG, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
...
// GTK318
    ...
    setExpandAlignProperties(gaintransmissionCurve, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
...
void Retinex::minmaxChanged(double cdma,
                            double cdmin,
                            double mini,
                            double maxi,
                            double Tmean,
...
void Retinex::setDefaults(const ProcParams* defParams, const ParamsEdited* pedited)
{
    ...
    if (pedited) {
        ...
        highlights->setDefaultEditedState(pedited->retinex.highlights ? Edited
                                                                      : UnEdited);
        h_tonalwidth->setDefaultEditedState(pedited->retinex.htonalwidth ? Edited
                                                                         : UnEdited);
        shadows->setDefaultEditedState(pedited->retinex.shadows ? Edited : UnEdited);
        s_tonalwidth->setDefaultEditedState(pedited->retinex.stonalwidth ? Edited
                                                                         : UnEdited);
...
void Retinex::setAdjusterBehavior(bool strAdd,
                                  bool neighAdd,
                                  bool limdAdd,
                                  bool offsAdd,
                                  bool vartAdd,
...
void Retinex::colorForValue(double valX,
                            double valY,
