...
HSVEqualizer::HSVEqualizer()
    : FoldableToolPanel(this, TOOL_NAME, M("TP_HSVEQUALIZER_LABEL"), false, true)
{
    ...
    curveEditorG = new CurveEditorGroup(App::get().mut_options().lastHsvCurvesDir,
    ...
    vshape = static_cast<FlatCurveEditor*>(
...
void HSVEqualizer::colorForValue(double valX,
                                 double valY,
