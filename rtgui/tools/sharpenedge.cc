...
SharpenEdge::SharpenEdge()
    : FoldableToolPanel(this, TOOL_NAME, M("TP_SHARPENEDGE_LABEL"), true, true)
{
    ...
    threechannels =
        Gtk::manage(new Gtk::CheckButton((M("TP_SHARPENEDGE_THREE"))));  // L + a + b
    ...
    chanthreeconn = threechannels->signal_toggled().connect(
        sigc::mem_fun(*this, &SharpenEdge::chanthree_toggled));
}
