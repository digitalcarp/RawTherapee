...
Wavelet::Wavelet()
    : FoldableToolPanel(this, TOOL_NAME, M("TP_WAVELET_LABEL"), true, true),
      curveEditorG(new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                                        M("TP_WAVELET_CONTEDIT"))),
      // curveEditorC(new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
      // M("TP_WAVELET_CONTRASTEDIT"))),
      CCWcurveEditorG(new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                                           M("TP_WAVELET_CCURVE"))),
      curveEditorbl(new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                                         M("TP_WAVELET_BLCURVE"))),
      ...
      opaCurveEditorG(new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                                           M("TP_WAVELET_COLORT"))),
      opacityCurveEditorG(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_OPACITY"))),
      CurveEditorwavnoise(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_DENOISE"))),
      CurveEditorwavnoiseh(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_DENOISEH"))),
      CurveEditorwavguid(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_DENOISEGUID"))),
      CurveEditorwavhue(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_DENOISEHUE"))),
      opacityCurveEditorW(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_OPACITYW"))),
      opacityCurveEditorWL(
          new CurveEditorGroup(App::get().mut_options().lastWaveletCurvesDir,
                               M("TP_WAVELET_OPACITYWL"))),
      ...
      offset(Gtk::manage(new Adjuster(M("TP_WAVELET_WAVOFFSET"),
                                      0.33,
                                      1.66,
                                      0.01,
                                      1.,
      ...
      hueskin(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_HUESKIN"),
                                                -314.,
                                                314.,
                                                -5.,
                                                25.,
                                                ...
                                                0,
                                                false))),
      hueskin2(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_HUESKY"),
                                                 -314.,
                                                 314.,
                                                 -260.,
                                                 -250,
                                                 ...
                                                 0,
                                                 false))),
      hllev(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_HIGHLIGHT"),
                                              0.,
                                              100.,
                                              50.,
                                              75.,
                                              ...
                                              0,
                                              false))),
      bllev(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LOWLIGHT"),
                                              0.,
                                              100.,
                                              0.,
                                              2.,
                                              ...
                                              0,
                                              false))),
      pastlev(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_PASTEL"),
                                                0.,
                                                70.,
                                                0.,
                                                2.,
                                                ...
                                                0,
                                                false))),
      satlev(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_SAT"),
                                               0.,
                                               130.,
                                               30.,
                                               45.,
                                               ...
                                               0,
                                               false))),
      edgcont(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_EDGCONT"),
                                                0.,
                                                100.,
                                                0,
                                                10,
                                                ...
                                                0.,
                                                false))),
      level0noise(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVZERO"),
                                                    -30.,
                                                    100.,
                                                    0.,
                                                    M("TP_WAVELET_STREN"),
                                                    ...
                                                    nullptr,
                                                    false))),
      level1noise(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVONE"),
                                                    -30.,
                                                    100.,
                                                    0.,
                                                    M("TP_WAVELET_STREN"),
                                                    ...
                                                    nullptr,
                                                    false))),
      level2noise(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVTWO"),
                                                    -30.,
                                                    100.,
                                                    0.,
                                                    M("TP_WAVELET_STREN"),
                                                    ...
                                                    nullptr,
                                                    false))),
      level3noise(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVTHRE"),
                                                    -30.,
                                                    100.,
                                                    0.,
                                                    M("TP_WAVELET_STREN"),
                                                    ...
                                                    nullptr,
                                                    false))),
      leveldenoise(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVFOUR"),
                                                     0.,
                                                     100.,
                                                     0.,
                                                     M("TP_WAVELET_DEN5THR"),
                                                     1,
                                                     0.,
                                                     100.,
                                                     0.,
                                                     ...
                                                     nullptr,
                                                     false))),
      levelsigm(Gtk::manage(new ThresholdAdjuster(M("TP_WAVELET_LEVELSIGM"),
                                                  0.05,
                                                  3.,
                                                  1.,
                                                  M("TP_WAVELET_LEVELHIGH"),
                                                  1,
                                                  0.05,
                                                  3.,
                                                  1.,
                                                  M("TP_WAVELET_LEVELLOW"),
                                                  1.,
                                                  nullptr,
                                                  false))),
      ...
      ballum(Gtk::manage(new Adjuster(M("TP_WAVELET_BALLUM"),
                                      -2.,
                                      10.,
                                      0.5,
                                      7.,
                                      ...
                                      Gtk::manage(new RTImage("circle-black-small"))))),
      balchrom(
          Gtk::manage(new Adjuster(M("TP_WAVELET_BALCHROM"),
                                   -100.,
                                   100.,
                                   1.,
                                   0.,
...

{
    ...
    daubcoeffmethodconn = daubcoeffmethod->signal_changed().connect(
        sigc::mem_fun(*this, &Wavelet::daubcoeffmethodChanged));
    ...
    Lmethodconn =
        Lmethod->signal_changed().connect(sigc::mem_fun(*this, &Wavelet::LmethodChanged));
    ...
    levdirSubHBox->pack_start(*Dirmethod, Gtk::PACK_EXPAND_WIDGET,
                              2);  // same, but 2 not 4?
    ...
    std::vector<GradientMilestone> mileston = { GradientMilestone(0., 0., 1., 0.),
    ...
    linkedgConn =
        linkedg->signal_toggled().connect(sigc::mem_fun(*this, &Wavelet::linkedgToggled));
    ...
    wavdenoise->setResetCurve(FlatCurveType(default_params.wavdenoise.at(0)),
                              default_params.wavdenoise);
    ...
    wavdenoiseh->setResetCurve(FlatCurveType(default_params.wavdenoiseh.at(0)),
                               default_params.wavdenoiseh);
    ...
    ccshape->setResetCurve(FlatCurveType(default_params.ccwcurve.at(0)),
                           default_params.ccwcurve);
    ...
    blshape->setResetCurve(FlatCurveType(default_params.blcurve.at(0)),
                           default_params.blcurve);
...
void Wavelet::wavChanged(double nlevel)
{
    if (!batchMode) {
        idle_register.add([this, nlevel]() -> bool {
            wavLabels->set_text(Glib::ustring::compose(
...
// WARNING!  In mutiImage mode, and for sliders in ADD mode, this will reset the slider to
// 0, but not to the default value as in SET mode.
...
void Wavelet::read(const ProcParams* pp, const ParamsEdited* pedited)
{
    ...
    labgrid->setParams(pp->wavelet.labgridALow / WaveletParams::LABGRID_CORR_MAX,
                       pp->wavelet.labgridBLow / WaveletParams::LABGRID_CORR_MAX,
                       pp->wavelet.labgridAHigh / WaveletParams::LABGRID_CORR_MAX,
                       pp->wavelet.labgridBHigh / WaveletParams::LABGRID_CORR_MAX, 0, 0,
                       0, 0, 0, 0, false);
    ...
    /*****************************************************************************************************
     *
     *           Set the inconsistent state (for combobox, select the "GENERAL_UNCHANGED"
     *entry)
     *
     *****************************************************************************************************/
    ...
    if (pedited) {
        ...
        labgrid->setEdited(pedited->wavelet.labgridALow || pedited->wavelet.labgridBLow
        ...
        edgedetectthr2->setEditedState(pedited->wavelet.edgedetectthr2 ? Edited
                                                                       : UnEdited);
...
void Wavelet::write(ProcParams* pp, ParamsEdited* pedited)
{
    ...
    double zerox = 0.;
    double zeroy = 0.;
    labgrid->getParams(pp->wavelet.labgridALow, pp->wavelet.labgridBLow,
                       pp->wavelet.labgridAHigh, pp->wavelet.labgridBHigh, zerox, zeroy,
...
void Wavelet::setDefaults(const ProcParams* defParams, const ParamsEdited* pedited)
{
    ...
    labgrid->setDefault(defParams->wavelet.labgridALow / WaveletParams::LABGRID_CORR_MAX,
                        defParams->wavelet.labgridBLow / WaveletParams::LABGRID_CORR_MAX,
                        defParams->wavelet.labgridAHigh / WaveletParams::LABGRID_CORR_MAX,
                        defParams->wavelet.labgridBHigh / WaveletParams::LABGRID_CORR_MAX,
                        0, 0, 0, 0, 0, 0);
    ...
    if (pedited) {
        ...
        softradend->setDefaultEditedState(pedited->wavelet.softradend ? Edited
                                                                      : UnEdited);
        ...
        threshold2->setDefaultEditedState(pedited->wavelet.threshold2 ? Edited
                                                                      : UnEdited);
        edgedetect->setDefaultEditedState(pedited->wavelet.edgedetect ? Edited
                                                                      : UnEdited);
        edgedetectthr->setDefaultEditedState(pedited->wavelet.edgedetectthr ? Edited
                                                                            : UnEdited);
        edgedetectthr2->setDefaultEditedState(pedited->wavelet.edgedetectthr2 ? Edited
                                                                              : UnEdited);
        ...
        skinprotect->setDefaultEditedState(pedited->wavelet.skinprotect ? Edited
                                                                        : UnEdited);
        ...
        level0noise->setDefaultEditedState(pedited->wavelet.level0noise ? Edited
                                                                        : UnEdited);
        level1noise->setDefaultEditedState(pedited->wavelet.level1noise ? Edited
                                                                        : UnEdited);
        level2noise->setDefaultEditedState(pedited->wavelet.level2noise ? Edited
                                                                        : UnEdited);
        level3noise->setDefaultEditedState(pedited->wavelet.level3noise ? Edited
                                                                        : UnEdited);
        leveldenoise->setDefaultEditedState(pedited->wavelet.leveldenoise ? Edited
                                                                          : UnEdited);
        levelsigm->setDefaultEditedState(pedited->wavelet.levelsigm ? Edited : UnEdited);

        for (int i = 0; i < 9; i++) {
            correction[i]->setDefaultEditedState(pedited->wavelet.c[i] ? Edited
                                                                       : UnEdited);
        }

        for (int i = 0; i < 9; i++) {
            correctionch[i]->setDefaultEditedState(pedited->wavelet.ch[i] ? Edited
                                                                          : UnEdited);
        }
    } else {
...
void Wavelet::adjusterChanged(ThresholdAdjuster* a, double newBottom, double newTop)
{
    if (listener && (multiImage || getEnabled())) {
        if (a == level0noise) {
            ...
            usleep(150);
            listener->panelChanged(
                EvWavlevelsigm, Glib::ustring::compose(
...
void Wavelet::adjusterChanged(ThresholdAdjuster* a,
...
void Wavelet::adjusterChanged2(ThresholdAdjuster* a,
                               int newBottomL,
                               int newTopL,
                               int newBottomR,
                               int newTopR)
...
void Wavelet::ushamethodChanged()
{
    ...
    } else if (ushamethod->get_active_row_number() == 0 && expclari->getEnabled() == true)
    {
        ...
        CLmethod->set_sensitive(false);
        Backmethod->set_sensitive(false);
        /*  }  else if (ushamethod->get_active_row_number() == 0 || expclari->getEnabled()
           == false) { Backmethod->set_active(1); CLmethod->set_active(3);
...
void Wavelet::adjusterChanged(Adjuster* a, double newval)
{
    if (listener && (multiImage || getEnabled())) {
        ...
        {
            listener->panelChanged(
                EvWavelet, Glib::ustring::compose(
                               "%1, %2, %3, %4, %5, %6, %7, %8, %9",
                               ...
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[3]->getValue()),
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[4]->getValue()),
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[5]->getValue()),
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[6]->getValue()),
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[7]->getValue()),
                               Glib::ustring::format(std::fixed, std::setprecision(0),
                                                     correction[8]->getValue())));
        } else if (a == correctionch[0] || a == correctionch[1] || a == correctionch[2]
                   || a == correctionch[3] || a == correctionch[4] || a == correctionch[5]
                   || a == correctionch[6] || a == correctionch[7]
                   || a == correctionch[8])
        {
            listener->panelChanged(
                EvWaveletch, Glib::ustring::compose(
                                 "%1, %2, %3, %4, %5, %6, %7, %8, %9",
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[0]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[1]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[2]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[3]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[4]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[5]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[6]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
                                                       correctionch[7]->getValue()),
                                 Glib::ustring::format(std::fixed, std::setprecision(0),
...
void Wavelet::colorForValue(double valX,
                            double valY,
...
void Wavelet::setAdjusterBehavior(bool multiplieradd,
                                  bool thresholdadd,
                                  bool threshold2add,
                                  bool thresadd,
                                  bool chroadd,
                                  ...
                                  bool gammaadd,
                                  bool edgedetectadd,
                                  bool edgedetectthradd,
                                  bool edgedetectthr2add)
{
