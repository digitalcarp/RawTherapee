    ...
    : Gtk::Dialog(title, parent)
{
    ...
    hb->pack_start(*Gtk::manage(new Gtk::Label(M("DYNPROFILEEDITOR_PROFILE"))), false,
                   false, 4);
    ...
    hb->pack_start(*Gtk::manage(new Gtk::Label(M("EXIFFILTER_IMAGETYPE"))), false, false,
                   4);
      ...
      button_delete_(M("DYNPROFILEEDITOR_DELETE"))
{
    ...
    if (col) {
        col->set_cell_data_func(*cell,
                                sigc::mem_fun(*this, &DynamicProfilePanel::render_lens));
    }
    ...
    if (col) {
        col->set_cell_data_func(*cell,
                                sigc::mem_fun(*this, &DynamicProfilePanel::render_path));
    }
    ...
    if (col) {
        col->set_cell_data_func(*cell,
                                sigc::mem_fun(*this, &DynamicProfilePanel::render_iso));
    }
...
void DynamicProfilePanel::render_profilepath(Gtk::CellRenderer* cell,
...
void DynamicProfilePanel::render_shutterspeed(Gtk::CellRenderer* cell,
                                              const Gtk::TreeModel::iterator& iter)
{
...
void DynamicProfilePanel::render_path(Gtk::CellRenderer* cell,
                                      const Gtk::TreeModel::iterator& iter)
{
