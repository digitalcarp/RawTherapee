...
public:
     ...
     * @param curve Actual curve for the return value. The actual curve type (given by the
     * first value of the vector) should be kept the same. Change the curve type if REALLY
     * necessary! */
    ...
    virtual float
    blendPipetteValues(CurveEditor* ce, float chan1, float chan2, float chan3)
    {
        float retVal = 0.f;
        int n = 0;
