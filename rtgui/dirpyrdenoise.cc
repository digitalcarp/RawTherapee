...
DirPyrDenoise::DirPyrDenoise () : FoldableToolPanel(this, TOOL_NAME, M("TP_DIRPYRDENOISE_LABEL"), true, true), lastmedian(false)
{
    ...
    Gtk::Box*  lumaVBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
    ...
    Gtk::Box* chromaVBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
    ...
    Gtk::Box* medianVBox = Gtk::manage ( new Gtk::Box(Gtk::Orientation::VERTICAL));
