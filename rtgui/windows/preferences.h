...
class Preferences final : public Gtk::Dialog, public ProfileStoreListener
{
    ...
    Options moptions;
    sigc::connection tconn, sconn, fconn, cpfconn, addc, setc, dfconn, ffconn, bpconn,
        rpconn, ipconn;
    sigc::connection autoMonProfileConn, sndEnableConn, langAutoDetectConn,
        autocielabConn, observer10Conn;
    ...
    void
    parseDir(Glib::ustring dirname, std::vector<Glib::ustring>& items, Glib::ustring ext);
    ...
    void appendBehavList(Gtk::TreeModel::iterator& parent,
                         Glib::ustring label,
                         int id,
                         bool set);
