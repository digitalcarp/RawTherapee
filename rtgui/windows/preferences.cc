...
namespace {
void placeSpinBox(Gtk::Container* where,
                  Gtk::SpinButton*& spin,
      ...
      swFavorites(nullptr)
{
    ...
    initialFontSize = defaultFontDesc.get_size()
                      / Pango::SCALE;  // Font size is managed in ()"pt" * Pango::SCALE)
                                       // by Pango (also refer to notes in rtscalable.h)
...
Gtk::Widget* Preferences::getBatchProcPanel()
{
    ...
    appendBehavList(mi, M("TP_EXPOSURE_COMPRHIGHLIGHTSTHRESHOLD"), ADDSET_TC_HLCOMPTHRESH,
                    false);
    ...
    appendBehavList(mi, M("TP_EPD_REWEIGHTINGITERATES"), ADDSET_EPD_REWEIGHTINGITERATES,
                    false);
    ...
    appendBehavList(mi, M("TP_TONE_EQUALIZER_DETAIL"),
                    ADDSET_TONE_EQUALIZER_REGULARIZATION, false);
    ...
    appendBehavList(mi, M("TP_LOCALCONTRAST_DARKNESS"), ADDSET_LOCALCONTRAST_DARKNESS,
                    false);
    appendBehavList(mi, M("TP_LOCALCONTRAST_LIGHTNESS"), ADDSET_LOCALCONTRAST_LIGHTNESS,
                    false);
    ...
    appendBehavList(mi, M("TP_SHARPENMICRO_CONTRAST"), ADDSET_SHARPENMICRO_CONTRAST,
                    false);
    appendBehavList(mi, M("TP_SHARPENMICRO_UNIFORMITY"), ADDSET_SHARPENMICRO_UNIFORMITY,
                    false);

    mi = behModel->append();
    mi->set_value(behavColumns.label, M("TP_DIRPYRDENOISE_LABEL"));
    appendBehavList(mi, M("TP_DIRPYRDENOISE_LUMINANCE_SMOOTHING"), ADDSET_DIRPYRDN_LUMA,
                    true);
    appendBehavList(mi, M("TP_DIRPYRDENOISE_LUMINANCE_DETAIL"), ADDSET_DIRPYRDN_LUMDET,
                    true);
    appendBehavList(mi, M("TP_DIRPYRDENOISE_CHROMINANCE_MASTER"), ADDSET_DIRPYRDN_CHROMA,
                    true);
    ...
    appendBehavList(mi, M("TP_DIRPYRDENOISE_MEDIAN_PASSES"), ADDSET_DIRPYRDN_PASSES,
                    true);
    ...
    appendBehavList(
        mi, M("TP_COLORAPP_LABEL_SCENE") + " - " + M("TP_COLORAPP_ABSOLUTELUMINANCE"),
        ADDSET_CAT_ADAPTSCENE, true);
    appendBehavList(
        mi, M("TP_COLORAPP_LABEL_VIEWING") + " - " + M("TP_COLORAPP_ABSOLUTELUMINANCE"),
    ...
    appendBehavList(mi, M("TP_FILMSIMULATION_STRENGTH"), ADDSET_FILMSIMULATION_STRENGTH,
                    true);
    ...
    appendBehavList(mi, M("TP_COLORTONING_SATURATEDOPACITY"),
                    ADDSET_COLORTONING_SATOPACITY, true);
    ...
    appendBehavList(mi, M("TP_FRAMING_BORDER_SIZE"), ADDSET_FRAMING_RELATIVE_SCALE,
                    false);
    ...
    appendBehavList(mi, M("TP_LENSGEOM_SCALE_HORIZONTALLY"),
                    ADDSET_LENSGEOM_SCALE_HORIZONTALLY, true);

    mi = behModel->append();
    mi->set_value(behavColumns.label, M("TP_LENSGEOM_SCALE_VERTICALLY"));
    appendBehavList(mi, M("TP_LENSGEOM_SCALE_VERTICALLY"),
                    ADDSET_LENSGEOM_SCALE_VERTICALLY, true);
    ...
    appendBehavList(mi,
                    M("TP_PERSPECTIVE_METHOD_SIMPLE") + " - "
    ...
    appendBehavList(
        ...
        M("TP_PERSPECTIVE_CAMERA_FRAME") + " - " + M("TP_PERSPECTIVE_CAMERA_ROLL") + ", "
            + M("TP_PERSPECTIVE_CAMERA_YAW") + ", " + M("TP_PERSPECTIVE_CAMERA_PITCH"),
    ...
    appendBehavList(mi, M("TP_PERSPECTIVE_PROJECTION_ROTATE"), ADDSET_PERSP_PROJ_ROTATE,
                    false);
    appendBehavList(mi,
    ...
    appendBehavList(mi, M("TP_VIGNETTING_CENTER_X") + ", " + M("TP_VIGNETTING_CENTER_Y"),
    ...
    appendBehavList(mi, M("TP_DIRPYREQUALIZER_THRESHOLD"), ADDSET_DIRPYREQ_THRESHOLD,
                    true);
    ...
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_RAW_SENSOR_BAYER_LABEL"));
    appendBehavList(mi, M("TP_RAW_FALSECOLOR"), ADDSET_BAYER_FALSE_COLOR_SUPPRESSION,
                    false);
    appendBehavList(mi, M("TP_RAW_DCBITERATIONS") + ", " + M("TP_RAW_LMMSEITERATIONS"),
                    ADDSET_BAYER_ITER, false);
    appendBehavList(mi, M("TP_RAW_DUALDEMOSAICCONTRAST"), ADDSET_BAYER_DUALDEMOZCONTRAST,
                    false);
    ...
    appendBehavList(mi, M("TP_RAW_FALSECOLOR"), ADDSET_XTRANS_FALSE_COLOR_SUPPRESSION,
                    false);

    mi = behModel->append();
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_PREPROCESS_LABEL"));
    appendBehavList(mi, M("TP_PREPROCESS_GREENEQUIL"), ADDSET_PREPROCESS_GREENEQUIL,
                    false);
    appendBehavList(mi, M("TP_PREPROCESS_LINEDENOISE"), ADDSET_PREPROCESS_LINEDENOISE,
                    true);

    mi = behModel->append();
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_EXPOS_WHITEPOINT_LABEL"));
    appendBehavList(mi, M("TP_RAWEXPOS_LINEAR"), ADDSET_RAWEXPOS_LINEAR, false);

    mi = behModel->append();
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_EXPOS_BLACKPOINT_LABEL"));
    appendBehavList(mi, M("TP_RAWEXPOS_RGB"), ADDSET_RAWEXPOS_BLACKS, false);

    mi = behModel->append();
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_FLATFIELD_LABEL"));
    appendBehavList(mi, M("TP_FLATFIELD_CLIPCONTROL"), ADDSET_RAWFFCLIPCONTROL, true);

    mi = behModel->append();
    mi->set_value(behavColumns.label,
                  M("MAIN_TAB_RAW") + " - " + M("TP_RAWCACORR_LABEL"));
...
void Preferences::appendBehavList(Gtk::TreeModel::iterator& parent,
                                  Glib::ustring label,
                                  int id,
                                  bool set)
{
...
Gtk::Widget* Preferences::getImageProcessingPanel()
{
    ...
    Gtk::Label* cpltypelab = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_CUSTPROFBUILDKEYFORMAT") + ":", Gtk::ALIGN_START));
    ...
    setExpandAlignProperties(metadataSyncCombo, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(mlbl, false, false, Gtk::ALIGN_START, Gtk::ALIGN_CENTER);
    setExpandAlignProperties(xmpSidecarCombo, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(darkFrameDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(flatFieldDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clutsDirLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clutsRestartNeeded, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(cameraProfilesDirLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(cameraProfilesDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);

    dirgrid->attach_next_to(*cameraProfilesDirLabel, *clutsDirLabel, Gtk::POS_BOTTOM, 1,
                            1);
    dirgrid->attach_next_to(*cameraProfilesDir, *cameraProfilesDirLabel, Gtk::POS_RIGHT,
                            1, 1);
    ...
    setExpandAlignProperties(lensProfilesDirLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    lensProfilesDir = Gtk::manage(new MyFileChooserButton(
        M("PREFERENCES_LENSPROFILESDIR"), Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(lensProfilesDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);

    dirgrid->attach_next_to(*lensProfilesDirLabel, *cameraProfilesDirLabel,
                            Gtk::POS_BOTTOM, 1, 1);
    dirgrid->attach_next_to(*lensProfilesDir, *lensProfilesDirLabel, Gtk::POS_RIGHT, 1,
                            1);
    ...
    setExpandAlignProperties(lensfunDbDirLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(lensfunDbDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    dirgrid->attach_next_to(*lensfunDbDirLabel, *lensProfilesDirLabel, Gtk::POS_BOTTOM, 1,
                            1);
    dirgrid->attach_next_to(*lensfunDbDir, *lensfunDbDirLabel, Gtk::POS_RIGHT, 1, 1);
    dirgrid->attach_next_to(*lensfunDbDirRestartNeededLabel, *lensfunDbDir,
                            Gtk::POS_RIGHT, 1, 1);
...
Gtk::Widget* Preferences::getPerformancePanel()
{
    ...
    placeSpinBox(chunkSizeVB, chunkSizeAMSB, "PREFERENCES_CHUNKSIZE_RAW_AMAZE", 0, 1, 5,
                 2, 1, 16);
    placeSpinBox(chunkSizeVB, chunkSizeCASB, "PREFERENCES_CHUNKSIZE_RAW_CA", 0, 1, 5, 2,
                 1, 16);
    placeSpinBox(chunkSizeVB, chunkSizeRCDSB, "PREFERENCES_CHUNKSIZE_RAW_RCD", 0, 1, 5, 2,
                 1, 16);
    placeSpinBox(chunkSizeVB, chunkSizeRGBSB, "PREFERENCES_CHUNKSIZE_RGB", 0, 1, 5, 2, 1,
                 16);
    placeSpinBox(chunkSizeVB, chunkSizeXTSB, "PREFERENCES_CHUNKSIZE_RAW_XT", 0, 1, 5, 2,
                 1, 16);
    ...
    placeSpinBox(threadsVBox, threadsSpinBtn, "PREFERENCES_PERFORMANCE_THREADS_LABEL", 0,
                 1, 5, 2, 0, maxThreadNumber);
...
Gtk::Widget* Preferences::getColorManPanel()
{
    ...
    iccDir = Gtk::manage(new MyFileChooserButton(M("PREFERENCES_ICCDIR"),
    ...
    Gtk::Label* monProfileRestartNeeded = Gtk::manage(
        new Gtk::Label(Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(monProfileRestartNeeded, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    Gtk::Label* mplabel =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_MONPROFILE") + ":", Gtk::ALIGN_START));
    ...
    setExpandAlignProperties(cbAutoMonProfile, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
...
Gtk::Widget* Preferences::getGeneralPanel()
{
    ...
    setExpandAlignProperties(workflowGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);

    Gtk::Label* flayoutlab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_EDITORLAYOUT") + ":"));
    setExpandAlignProperties(flayoutlab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    editorLayout = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(editorLayout, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    Gtk::Label* lNextStart = Gtk::manage(
        new Gtk::Label(Glib::ustring("(") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(lNextStart, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(curveBBoxPosL, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    curveBBoxPosC = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(curveBBoxPosC, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    Gtk::Label* curveBBoxPosRestartL = Gtk::manage(
        new Gtk::Label(Glib::ustring("(") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(curveBBoxPosRestartL, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    workflowGrid->attach_next_to(*curveBBoxPosRestartL, *lNextStart, Gtk::POS_BOTTOM, 1,
                                 1);

    curveBBoxPosS = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(curveBBoxPosS, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);

    Gtk::Label* complexityL =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_COMPLEXITYLOC") + ":"));
    setExpandAlignProperties(complexityL, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    complexitylocal = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(complexitylocal, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(spotlocalL, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    spotlocal = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(spotlocal, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(zoomOnScrollCB, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(inspectorWindowCB, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    // workflowGrid->attach_next_to(*inspectorWindowCB, *complexitylocal, Gtk::POS_BOTTOM,
    // 1, 1);
    workflowGrid->attach_next_to(*inspectorWindowCB, *spotlocal, Gtk::POS_BOTTOM, 1, 1);
    Gtk::Label* inspectorNextStartL = Gtk::manage(
        new Gtk::Label(Glib::ustring("(") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(inspectorNextStartL, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*inspectorNextStartL, *inspectorWindowCB, Gtk::POS_RIGHT,
                                 1, 1);

    ckbHistogramPositionLeft =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_HISTOGRAMPOSITIONLEFT")));
    setExpandAlignProperties(ckbHistogramPositionLeft, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*ckbHistogramPositionLeft, *zoomOnScrollCB,
                                 Gtk::POS_BOTTOM, 1, 1);
    ...
    setExpandAlignProperties(ckbShowFilmStripToolBar, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_START);
    workflowGrid->attach_next_to(*ckbFileBrowserToolbarSingleRow,
                                 *ckbHistogramPositionLeft, Gtk::POS_BOTTOM, 1, 1);
    workflowGrid->attach_next_to(*ckbShowFilmStripToolBar, *inspectorWindowCB,
                                 Gtk::POS_BOTTOM, 2, 1);

    Gtk::Label* hb4label = Gtk::manage(new Gtk::Label(M("PREFERENCES_TP_LABEL")));
    setExpandAlignProperties(hb4label, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ckbHideTPVScrollbar =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_TP_VSCROLLBAR")));
    setExpandAlignProperties(ckbHideTPVScrollbar, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*hb4label, *ckbFileBrowserToolbarSingleRow,
                                 Gtk::POS_BOTTOM, 1, 1);
    ...
    setExpandAlignProperties(btnSaveTpOpenNow, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*btnSaveTpOpenNow, *ckbAutoSaveTpOpen, Gtk::POS_RIGHT, 1,
                                 1);
    ...
    setExpandAlignProperties(ckbshowtooltiplocallab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_START);
    workflowGrid->attach_next_to(*ckbshowtooltiplocallab, *ckbFileBrowserToolbarSingleRow,
                                 Gtk::POS_RIGHT, 1, 1);
    ...
    setExpandAlignProperties(langGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);

    ckbLangAutoDetect =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_LANGAUTODETECT")));
    setExpandAlignProperties(ckbLangAutoDetect, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);

    Gtk::Label* langlab = Gtk::manage(new Gtk::Label(M("PREFERENCES_SELECTLANG") + ":"));
    setExpandAlignProperties(langlab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    languages = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(languages, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    for (const auto& lang : langs) {
        if ("default" != lang && "README" != lang && "LICENSE" != lang) {
            auto lang_metadata = langMgr.getMetadata(
                Glib::build_filename(App::get().argv0() + "/languages", lang));
    ...
    setExpandAlignProperties(appearanceGrid, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    Gtk::Label* themeRestartLbl = Gtk::manage(
        new Gtk::Label(Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(themeRestartLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(cropMaskColorLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(navGuideColorLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(panFactorLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    panFactor = Gtk::manage(new Gtk::SpinButton());
    setExpandAlignProperties(panFactor, true, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    navigationGrid->attach_next_to(*rememberZoomPanCheckbutton, *panFactorLabel,
                                   Gtk::POS_BOTTOM, 2, 1);
    ...
    editor_dir_custom_path =
        Gtk::manage(new MyFileChooserButton("", Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
...
Gtk::Widget* Preferences::getFileBrowserPanel()
{
    ...
    Gtk::Label* dflab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_DATEFORMAT") + ":", Gtk::ALIGN_START));
    ...
    setExpandAlignProperties(ckbmenuGroupRank, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ckbmenuGroupLabel =
    ...
    setExpandAlignProperties(ckbmenuGroupFileOperations, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(cacheGrid, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);

    Gtk::Label* maxThumbHeightLbl =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_CACHETHUMBHEIGHT") + ":"));
    setExpandAlignProperties(maxThumbHeightLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(maxCacheEntriesLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clearThumbsLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clearProfilesLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clearAllLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clearSafetyLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_START);
...
void Preferences::parseDir(Glib::ustring dirname,
                           ...
                           Glib::ustring ext)
{
    ...
    for (Glib::DirIterator i = dir->begin(); i != dir->end(); ++i) {
        ...
        // ignore directories
        if (!Glib::file_test(fname, Glib::FILE_TEST_IS_DIR) && sname.size() >= ext.size()
...
void Preferences::storePreferences()
{
    ...
    // With the new mechanism, we can't be sure of the availability of the DEFPROFILE_RAW
    // & DEFPROFILE_IMG profiles, because useBundledProfiles may be false. We're now using
    // DEFPROFILE_INTERNAL instead, which is always available.
    ...
    for (unsigned i = 0; i < editors.size(); i++) {
        moptions.externalEditors[i] =
            (ExternalEditor(editors[i].name, editors[i].command,
                            editors[i].native_command, editors[i].icon_serialized));
...
void Preferences::fillPreferences()
{
    ...
    for (const auto& editor : moptions.externalEditors) {
        editorInfos.emplace_back(editor.name, editor.command, editor.icon_serialized,
    ...
    editor_dir_current->set_active(moptions.editor_out_dir
                                   == Options::EDITOR_OUT_DIR_CURRENT);
    editor_dir_custom->set_active(moptions.editor_out_dir
                                  == Options::EDITOR_OUT_DIR_CUSTOM);
    ...
    thumbnailRankColorMode->set_active(moptions.thumbnailRankColorMode
                                       == Options::ThumbnailPropertyMode::XMP);
}
...
{
    // TODO: Find a way to get and restore the current selection; the following line can't
    // work anymore
...
void Preferences::switchThemeTo(Glib::ustring newTheme)
{
    ...
    Glib::ustring filename(
        Glib::build_filename(App::get().argv0(), "themes", newTheme + ".css"));

    if (!themecss) {
        themecss = Gtk::CssProvider::create();
        Glib::RefPtr<Gdk::Screen> screen = Gdk::Screen::get_default();
        Gtk::StyleContext::add_provider_for_screen(screen, themecss,
...
void Preferences::switchFontTo(const Glib::ustring& newFontFamily, const int newFontSize)
{
    ...
    if (!fontcss) {
        ...
        Glib::RefPtr<Gdk::Screen> screen = Gdk::Screen::get_default();
        Gtk::StyleContext::add_provider_for_screen(screen, fontcss,
                                                   GTK_STYLE_PROVIDER_PRIORITY_USER);
    }

    // Create css to load based on new font name and size
    const auto css = Glib::ustring::compose("* { font-family: %1; font-size: %2pt }",
...
void Preferences::workflowUpdate()
{
    ...
    if (moptions.histogramPosition != options.histogramPosition) {
        ...
        parent->updateHistogramPosition(options.histogramPosition,
                                        moptions.histogramPosition);
    }
