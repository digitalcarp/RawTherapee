                                             ...
                                             int& natural_height) const
{
    minimum_height = natural_height =
        surface ? surface->getHeight() : RTScalable::scalePixelSize(100);
}

void SplashImage::get_preferred_width_vfunc(int& minimum_width, int& natural_width) const
{
    minimum_width = natural_width =
        surface ? surface->getWidth() : RTScalable::scalePixelSize(100);
}

void SplashImage::get_preferred_height_for_width_vfunc(int width,
                                                       int& minimum_height,
                                                       int& natural_height) const
{
...
Splash::Splash(Gtk::Window& parent, bool modal)
    : Gtk::Dialog(M("GENERAL_ABOUT"), parent, modal)
{
    ...
    std::string buildFileName =
        Glib::build_filename(App::get().creditsPath(), "AboutThisBuild.txt");
    ...
    std::string creditsFileName =
        Glib::build_filename(App::get().creditsPath(), "AUTHORS.txt");
    ...
    std::string licenseFileName =
        Glib::build_filename(App::get().licensePath(), "LICENSE");
    ...
    std::string releaseNotesFileName =
        Glib::build_filename(App::get().creditsPath(), "RELEASE_NOTES.txt");
