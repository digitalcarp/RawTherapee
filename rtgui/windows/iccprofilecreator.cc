...
const char*
    sTRCPreset[] = { "BT709_g2.2_s4.5", "sRGB_g2.4_s12.92", "linear_g1.0",
                     "standard_g2.2",   "standard_g1.8",    "High_g1.3_s3.35",
                     "Low_g2.6_s6.9",   "Lab_g3.0s9.03296" /*, "PQ", "HLG" */ };  // gamma
                                                                                  // free
      ...
      parent(rtwindow)
{
    ...
    setExpandAlignProperties(primaries, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(primariesGrid, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    primariesGrid->set_column_spacing(5);

    aPrimariesRedX =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_REDX"), 0.4100, 0.9000, 0.0001,
                                 0.6400 /*, gamuts0, gamutl0*/));
    setExpandAlignProperties(aPrimariesRedX, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    aPrimariesRedY =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_REDY"), 0.1000, 0.6000, 0.0001,
                                 0.3300 /*, gamutl1, gamuts1*/));
    setExpandAlignProperties(aPrimariesRedY, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    aPrimariesGreenX =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_GREX"), -0.100, 0.4000, 0.0001,
                                 0.3000 /*, gamutl2, gamuts2*/));
    setExpandAlignProperties(aPrimariesGreenX, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    aPrimariesGreenY =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_GREY"), 0.50, 1.0000, 0.0001,
                                 0.6000 /*, gamuts3, gamutl3*/));
    setExpandAlignProperties(aPrimariesGreenY, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    aPrimariesBlueX =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_BLUX"), -0.1, 0.3000, 0.0001,
                                 0.1500 /*, gamutl4, gamuts4*/));
    setExpandAlignProperties(aPrimariesBlueX, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    aPrimariesBlueY =
        Gtk::manage(new Adjuster(M("ICCPROFCREATOR_PRIM_BLUY"), -0.100, 0.4000, 0.0001,
                                 0.060 /*, gamutl5, gamuts5*/));
    setExpandAlignProperties(aPrimariesBlueY, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(trcPresets, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(cIlluminant, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(proflab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    mainGrid->attach(*proflab, 0, 6, 1, 1);
    iccVersion = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(iccVersion, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(eDescription, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(cAppendParamsToDesc, true, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(copylab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ...
    setExpandAlignProperties(resetCopyright, false, false, Gtk::ALIGN_CENTER,
                             Gtk::ALIGN_CENTER);
...
void ICCProfileCreator::getPrimaries(const Glib::ustring& preset,
                                     double* p,
                                     ColorTemp& temp)
{
    temp = ColorTemp::D50;
...
void ICCProfileCreator::getGamma(const Glib::ustring& preset,
                                 double& presetGamma,
                                 double& presetSlope)
{
...
void ICCProfileCreator::savePressed()
{
    ...
    // -----------------setmedia white point for monitor  profile sRGB or AdobeRGB in case
    // of profile used for monitor---------------------
    ...
    if (!v2except) {
        ...
        // new model for v2 profile different from D50 by entering directly XYZ values and
        // media white point
        sNewProfile =
    ...
    */
    ...
    if (gammaPreset == "High_g1.3_s3.35") {
        ...
        rtengine::Color::calcGamma(pwr, ts,
                                   g_a);  // call to calcGamma with selected gamma and
        ...
        sGammaPreset = Glib::ustring::compose(
            "g%1_s%2",
    ...
    if (gammaPreset == "Custom") {
        ...
        sGamma = Glib::ustring::format(std::setw(6), std::fixed, std::setprecision(6),
                                       presetGamma);
        sSlope = Glib::ustring::format(std::setw(6), std::fixed, std::setprecision(5),
                                       presetSlope);
        fName = Glib::ustring::compose("RT%1_%2_%3.icc", profileVersion,
                                       sPrimariesAndIlluminant, sGammaPreset);
    ...
    Gtk::FileChooserDialog dialog(getToplevelWindow(this),
                                  M("ICCPROFCREATOR_SAVEDIALOG_TITLE"),
    ...
    */
    ...
    if (profileVersion == "v4" && illuminant != "DEF") {
        ...
        if (illuminant == "D50") {
            xyD = {
                0.3457, 0.3585, 1.0
            };  // white D50      near LCMS values but not perfect...it's a compromise!!
        }
        ...
        if (v2except) {
            ...
            // R G B destination
            double Rd =
                Wdx * MaBradford[0][0] + Wdy * MaBradford[1][0] + Wdz * MaBradford[2][0];
            double Gd =
                Wdx * MaBradford[0][1] + Wdy * MaBradford[1][1] + Wdz * MaBradford[2][1];
            double Bd =
                Wdx * MaBradford[0][2] + Wdy * MaBradford[1][2] + Wdz * MaBradford[2][2];
            ...
            //           mat_xyz_brad[1][0], mat_xyz_brad[2][2]);
