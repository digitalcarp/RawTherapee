...
protected:
    ...
    virtual void drawBar(const Cairo::RefPtr<Cairo::Context>& cc,
                         const double value,
    ...
    void getPreferredThicknessForLength(int length,
                                        int& min_thickness,
                                        int& natural_length) const;
    void getPreferredLengthForThickness(int thickness,
                                        int& min_length,
                                        int& natural_length) const;
...
public:
    ...
    bool updatePointer(const int new_r,
                       const int new_g,
                       const int new_b,
...
private:
    ...
    void drawBar(const Cairo::RefPtr<Cairo::Context>& cc,
                 const double value,
                 const double max_value,
                 const int winw,
                 const int winh) override;
    ...
    void get_preferred_height_for_width_vfunc(int width,
                                              int& minimum_height,
                                              int& natural_height) const override;
    void get_preferred_width_for_height_vfunc(int h,
                                              int& minimum_width,
...
public:
    ...
    // Update pointer values: returns true if widget needs redrawing
    bool updatePointer(const int r,
                       const int g,
                       const int b,
                       const rtengine::procparams::ColorManagementParams* cmp = nullptr);
    // Update histogram data
    void update(const LUTu& histRed,
...
private:
    ...
    void drawMarks(const Cairo::RefPtr<Cairo::Context>& cr,
                   ...
                   int& oi);
    void
    drawParade(const Cairo::RefPtr<Cairo::Context>& cr, const int hsize, const int vsize);
    void drawVectorscope(const Cairo::RefPtr<Cairo::Context>& cr,
                         const int hsize,
                         const int vsize);
    void drawWaveform(const Cairo::RefPtr<Cairo::Context>& cr,
                      const int hsize,
                      const int vsize);
...
{
private:
    DelayedCall<bool, const rtengine::procparams::ColorManagementParams*, int, int, int>
...
public:
    ...
    void histogramChanged(const LUTu& histRed,
                          const LUTu& histGreen,
                          const LUTu& histBlue,
                          const LUTu& histLuma,
                          const LUTu& histChroma,
