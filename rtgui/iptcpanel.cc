    ...
    embeddedData(new rtengine::procparams::IPTCPairs)
{
    ...
    setExpandAlignProperties(iptc, true, false, Gtk::Align::FILL, Gtk::Align::START);
    iptc->set_row_spacing(3);

    int row = 0;

    Gtk::Label* capl = Gtk::manage(new Gtk::Label(M("IPTCPANEL_DESCRIPTION") + ":"));
    setExpandAlignProperties(capl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    captionText = Gtk::TextBuffer::create();
    captionView = Gtk::manage(new Gtk::TextView(captionText));
    setExpandAlignProperties(captionView, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(capwl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    captionWriter = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(captionWriter, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(headl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    headline = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(headline, true, false, Gtk::Align::FILL, Gtk::Align::BASELINE);
    ...
    setExpandAlignProperties(instl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    instructions = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(instructions, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(catl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    category = Gtk::manage(new MyComboBoxText(true));
    category->set_size_request(75);
    setExpandAlignProperties(category, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(creatorLbl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    creator = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(creator, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(creatorJobTitleLbl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    creatorJobTitle = Gtk::manage(  new Gtk::Entry());
    setExpandAlignProperties(creatorJobTitle, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(credl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    credit = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(credit, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(sourl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    source = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(source, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(cprl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    copyright = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(copyright, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(cityl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    city = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(city, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(provl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    province = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(province, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(ctrl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    country = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(country, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(titll, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    title = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(title, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(dcl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    dateCreated = Gtk::manage(  new Gtk::Entry());
    setExpandAlignProperties(dateCreated, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(trl, true, false, Gtk::Align::START, Gtk::Align::CENTER);
    transReference = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(transReference, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
