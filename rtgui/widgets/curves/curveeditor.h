...
public:
    ...
    void refresh();  // refresh the display of the CurveEditor (e.g. when a ColoredBar has
...
protected:
    // reflects the buttonType active selection ; used as a pre-'selectionChange' reminder
    // value
...
public:
    ...
    // set the reset curve for a given curve type. This is optional; all curve type have a
    // default reset curve
