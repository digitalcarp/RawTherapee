    ...
    : CurveEditorSubGroup(curveDir)
{
    ...
    // paramCurveSliderBox needed to set vspacing(4) between curve+shc and sliders without
    // vspacing between each slider
    ...
    if (dCurve) {
        ...
        case (DCT_Parametric):
        {
            ...
            shcSelector->setMargins(
                (int)((leftBar ? (double)CBAR_WIDTH + 2. + (double)CBAR_MARGIN + RADIUS
                               : RADIUS)
                      - 1.5),
                (int)(RADIUS - 1.5));
