...
protected:
    ...
    // left margin, essentially a workaround to take care of an eventual right colored bar
    // (e.g. for curves)
    int leftMargin;
    // right margin, essentially a workaround to take care of an eventual right colored
    // bar
    int rightMargin;
