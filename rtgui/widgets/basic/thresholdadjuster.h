...
public:
    // Custom Threshold widget with 2 cursors (Top and Bottom) and a custom curve provided
    // by the instanciator, each cursor having his own range, default value and precision
