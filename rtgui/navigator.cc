...
GTK_STYLE_PROVIDER_PRIORITY_USER); lLAB_L->get_style_context()->add_provider(cssProvider,
GTK_STYLE_PROVIDER_PRIORITY_USER);
...
void Navigator::getRGBText(int r,
                           int g,
                           int b,
                           Glib::ustring& sR,
                           Glib::ustring& sG,
                           ...
                           bool isRaw)
{
    if (isRaw) {
        ...
        default:
            sR =
                Glib::ustring::format(std::fixed, std::setprecision(1), r * 100.f / 255.f)
                + Glib::ustring("%");
            sG =
                Glib::ustring::format(std::fixed, std::setprecision(1), g * 100.f / 255.f)
                + Glib::ustring("%");
            sB =
                Glib::ustring::format(std::fixed, std::setprecision(1), b * 100.f / 255.f)
                + Glib::ustring("%");
        }
    }
}

void Navigator::getHSVText(float h,
                           float s,
                           float v,
                           Glib::ustring& sH,
                           Glib::ustring& sS,
...
void Navigator::getLABText(float l,
                           float a,
                           float b,
                           Glib::ustring& sL,
                           Glib::ustring& sA,
