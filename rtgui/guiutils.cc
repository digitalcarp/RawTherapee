...
// Note: newW & newH must be > 0
bool BackBuffer::setDrawRectangle(Cairo::Surface::Format format, Gdk::Rectangle &rectangle, bool updateBackBufferSize)
{
...
// Note: newW & newH must be > 0
bool BackBuffer::setDrawRectangle(Cairo::Surface::Format format, int newX, int newY, int newW, int newH, bool updateBackBufferSize)
{
    assert(newW && newH);
