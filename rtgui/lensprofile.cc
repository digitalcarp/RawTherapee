...
LensProfilePanel::LensProfilePanel() :
    ...
    corrLcpFileChooser(Gtk::manage((new MyFileChooserButton(M("TP_LENSPROFILE_LABEL"), Gtk::FileChooser::Action::OPEN)))),
    ...
    ckbUseCA(Gtk::manage((new Gtk::CheckButton(M("TP_LENSPROFILE_USE_CA")))))
{
    ...
    setExpandAlignProperties(modesGrid, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);
    ...
    setExpandAlignProperties(distGrid, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);

    // Mode choice widgets:

    setExpandAlignProperties(corrLcpFileChooser, true, false, Gtk::Align::FILL, Gtk::Align::CENTER);

    // Manually-selected profile widgets:

    setExpandAlignProperties(lensfunCamerasLbl, false, false, Gtk::Align::END, Gtk::Align::CENTER);
