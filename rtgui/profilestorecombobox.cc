    ...
    const std::vector<const ProfileStoreEntry*>* entryList)
{
    for (auto entry : *entryList) {
        ...
        {  // filtering the entry of the same folder
...
Gtk::TreeIter ProfileStoreComboBox::findRowFromEntry_(Gtk::TreeModel::Children childs,
                                                      const ProfileStoreEntry* pse) const
{
...
Gtk::TreeIter ProfileStoreComboBox::findRowFromFullPath_(Gtk::TreeModel::Children childs,
                                                         int parentFolderId,
