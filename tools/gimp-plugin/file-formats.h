...
static const FileFormat file_formats[] = {
    { N_("Raw Canon"), "image/x-canon-cr2,image/x-canon-cr3,image/x-canon-crw",
      "cr2,cr3,crw", NULL,
    ...
    { N_("Raw Hasselblad"), "image/x-hasselblad-3fr,image/x-hasselblad-fff", "3fr,fff",
      NULL,
    ...
    { N_("Raw Sony"), "image/x-sony-arw,image/x-sony-srf,image/x-sony-sr2", "arw,srf,sr2",
      NULL,

      "file-rawtherapee-sony-load", "Load files in the Sony raw formats via rawtherapee",
      "This plug-in loads files in Sony's raw formats by calling rawtherapee." },

    { N_("Raw Casio BAY"), "image/x-casio-bay", "bay", NULL,

      "file-rawtherapee-bay-load", "Load files in the BAY raw format via rawtherapee",
    ...
    { N_("Raw Phantom Software CINE"), "", /* FIXME: find a mime type */
      ...
      "file-rawtherapee-cine-load", "Load files in the CINE raw format via rawtherapee",
    ...
    { N_("Raw Adobe DNG Digital Negative"), "image/x-adobe-dng", "dng", NULL,
      ...
      "file-rawtherapee-dng-load", "Load files in the DNG raw format via rawtherapee",
    ...
    { N_("Raw Epson ERF"), "image/x-epson-erf", "erf", NULL,
      ...
      "file-rawtherapee-erf-load", "Load files in the ERF raw format via rawtherapee",
      "This plug-in loads files in Epson's raw ERF format by calling rawtherapee." },

    { N_("Raw Phase One"), "image/x-phaseone-cap,image/x-phaseone-iiq", "cap,iiq", NULL,
    ...
    { N_("Raw Minolta"), "image/x-minolta-mdc,image/x-minolta-mrw", "mdc,mrw", NULL,
    ...
    { N_("Raw Mamiya MEF"), "image/x-mamiya-mef", "mef", NULL,
      ...
      "file-rawtherapee-mef-load", "Load files in the MEF raw format via rawtherapee",
      "This plug-in loads files in Mamiya's raw MEF format by calling rawtherapee." },

    { N_("Raw Leaf MOS"), "image/x-leaf-mos", "mos", NULL,

      "file-rawtherapee-mos-load", "Load files in the MOS raw format via rawtherapee",
      "This plug-in loads files in Leaf's raw MOS format by calling rawtherapee." },

    { N_("Raw Olympus ORF"), "image/x-olympus-orf", "orf", NULL,

      "file-rawtherapee-orf-load", "Load files in the ORF raw format via rawtherapee",
      "This plug-in loads files in Olympus' raw ORF format by calling rawtherapee." },

    { N_("Raw Pentax PEF"), "image/x-pentax-pef,image/x-pentax-raw", "pef,raw", NULL,

      "file-rawtherapee-pef-load", "Load files in the PEF raw format via rawtherapee",
      "This plug-in loads files in Pentax' raw PEF format by calling rawtherapee." },

    { N_("Raw Logitech PXN"), "image/x-pxn", /* FIXME: is that the correct mime type? */
      "pxn", NULL,

      "file-rawtherapee-pxn-load", "Load files in the PXN raw format via rawtherapee",
    ...
    { N_("Raw Apple QuickTake QTK"), "", /* FIXME: find a mime type */
      ...
      "file-rawtherapee-qtk-load", "Load files in the QTK raw format via rawtherapee",
      "This plug-in loads files in Apple's QuickTake QTK raw format by calling rawtherapee." },

    { N_("Raw Fujifilm RAF"), "image/x-fuji-raf", "raf", NULL,

      "file-rawtherapee-raf-load", "Load files in the RAF raw format via rawtherapee",
      "This plug-in loads files in Fujifilm's raw RAF format by calling rawtherapee." },

    { N_("Raw Panasonic"), "image/x-panasonic-raw,image/x-panasonic-rw2", "raw,rw2", NULL,
    ...
    { N_("Raw Digital Foto Maker RDC"), "", /* FIXME: find a mime type */
      ...
      "file-rawtherapee-rdc-load", "Load files in the RDC raw format via rawtherapee",
    ...
    { N_("Raw Leica RWL"), "image/x-leica-rwl", "rwl", NULL,
      ...
      "file-rawtherapee-rwl-load", "Load files in the RWL raw format via rawtherapee",
      "This plug-in loads files in Leica's raw RWL format by calling rawtherapee." },

    { N_("Raw Samsung SRW"), "image/x-samsung-srw", "srw", NULL,

      "file-rawtherapee-srw-load", "Load files in the SRW raw format via rawtherapee",
      "This plug-in loads files in Samsung's raw SRW format by calling rawtherapee." },

    { N_("Raw Sigma X3F"), "image/x-sigma-x3f", "x3f", NULL,

      "file-rawtherapee-x3f-load", "Load files in the X3F raw format via rawtherapee",
      "This plug-in loads files in Sigma's raw X3F format by calling rawtherapee." },

    { N_("Raw Arriflex ARI"), "", "ari", NULL,

      "file-rawtherapee-ari-load", "Load files in the ARI raw format via rawtherapee",
