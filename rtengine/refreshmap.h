...
#define M_VOID (1 << 20)
// Use M_MINUPDATE if you wish to update the preview without modifying the image (think
// about it like a "refreshPreview") Must NOT be used with other event (i.e. will be used
// for MINUPDATE only)
...
#define ALL                                                                   \
    (M_PREPROC | M_RAW | M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM \
     | M_BLURMAP | M_AUTOEXP | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE         \
     | M_COLOR)  // without HIGHQUAL
#define DARKFRAME                                                             \
    (M_PREPROC | M_RAW | M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM \
     | M_BLURMAP | M_AUTOEXP | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR)
#define FLATFIELD                                                             \
...
#define WB                                                                               \
    (M_WB | M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP \
     | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR)
#define COMPR                                                                     \
    (M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP \
     | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR | M_MONITOR)
#define ALLNORAW                                                                  \
    (M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP \
     | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR)
#define CAPTURESHARPEN                                                            \
    (M_INIT | M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP \
     | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR | M_CSHARP)
#define HDR                                                                           \
    (M_SPOT | M_LINDENOISE | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP | M_RGBCURVE \
     | M_LUMACURVE | M_LUMINANCE | M_COLOR)
#define SPOTADJUST                                                                   \
    (M_SPOT | M_HDR | M_BLURMAP | M_AUTOEXP | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE \
     | M_COLOR)
#define TRANSFORM                                                                    \
    (M_SPOT | M_HDR | M_TRANSFORM | M_BLURMAP | M_AUTOEXP | M_RGBCURVE | M_LUMACURVE \
     | M_LUMINANCE | M_COLOR)
#define AUTOEXP \
    (M_SPOT | M_HDR | M_AUTOEXP | M_RGBCURVE | M_LUMACURVE | M_LUMINANCE | M_COLOR)
